                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entities.RollingTask"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entities.Standup"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.CreateTeamRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "entities.Report": {
            ...
            "properties": {
                ...
                "report_type": {
                    "$ref": "#/definitions/entities.ReportType"
                },
                "team_id": {
                    "type": "string"
                }
        ...
        "entities.ReportType": {
            ...
            "x-enum-varnames": [
                "ReportTypeRollingTasks",
                "ReportTypeBlockers",
                "ReportTypeTeamSummary"
            ]
        },
        "entities.RollingTask": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
                ...
                "status": {
                    "$ref": "#/definitions/entities.RollingTaskStatus"
                },
                "task_description": {
                    "type": "string"
                },
